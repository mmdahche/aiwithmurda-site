...
<style>
  ...
  h1 { font-size: 52px; line-height: 1.02; margin: 0 0 36px; max-width: 900px; }
  h2 { color: #8aa296; font-size: 18px; margin: 30px 0 8px; text-transform: uppercase; letter-spacing: .08em; }
  p { color: #d8e7df; font-size: 26px; line-height: 1.32; max-width: 960px; }
  .grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 18px; margin: 26px 0; }
  .grid div { border: 1px solid #234232; background: #101a16; padding: 24px; border-radius: 10px; }
  span, em { display: block; color: #9fb2a8; font-style: normal; }
  strong { display: block; font-size: 34px; margin: 10px 0 4px; }
