...
Objective: Create the operating folder, tracker habit, account checklist, and proof capture lane before building.
...
Done criteria:
- You can start a build day without searching for files, links, or the next action.

## Module 2 - Problem To Proof

Objective: Choose a painful workflow, define the smallest useful fix, and name the proof metric before coding.
...
Done criteria:
- You know exactly what problem the build solves and what proof would make a viewer care.

## Module 3 - AI Build Loop

Objective: Use Claude Code, Codex, or your chosen stack to ship one narrow improvement without hiding the messy middle.
...
Done criteria:
- A real thing works better than it did before, and the change can be explained in under 30 seconds.

## Module 4 - Proof And Content

Objective: Turn the build into receipts: daily proof page, clip caption, recap, and one public asset.
...
Done criteria:
- The day produced a receipt page and at least one asset that points back to the sprint.

## Module 5 - Offer And Follow-Up

Objective: Connect proof to a simple offer so the sprint has a money path, not just attention.
...
Done criteria:
- The day's proof moved someone closer to buying, joining, booking, or replying.
