...
Free, local inbox cleanup for Gmail and iCloud. Version 1.2.0.
...
These are the individual commands behind the guided menu. Most people should
start with README.md and the platform launcher instead. The optional AI workflow
is in ai/START-WITH-AI.md; it uses the same cleanup engine.

## What comes with it

- A Python cleanup engine and guided menu, using only built-in libraries.
- A Mac and Windows setup guide, this walkthrough, a practice inbox, and an AI guide.
