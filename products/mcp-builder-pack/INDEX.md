...
- `00-START-HERE.md`
- `CHANGELOG.md`
- `examples/changelog-mcp-walkthrough.md`
- `install/claude-code/agent-action-space.md`
- `install/claude-code/mcp-server-build.md`
- `install/claude-code/mcp-server-patterns.md`
- `install/claude-code/regex-vs-llm.md`
- `install/codex/agent-action-space/SKILL.md`
...
- `payload/mcp-server-patterns.md`
- `payload/regex-vs-llm.md`
- `README.md`
- `VERIFY.md`
