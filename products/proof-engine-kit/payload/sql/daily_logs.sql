-- Public sprint scoreboard logs.
-- Reads are public by design. Writes go through your server admin API (service role).
...
-- Writes: deny direct client writes; route through admin API with bearer token.
