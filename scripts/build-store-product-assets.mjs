...
const STORE_PRODUCTS = [
  ...
  { slug: "browser-automation-studio", zip: "browser-automation-studio.zip" },
  { slug: "design-studio-pack", zip: "design-studio-pack.zip" },
  { slug: "content-engine-pack", zip: "content-engine-pack.zip" },
];
